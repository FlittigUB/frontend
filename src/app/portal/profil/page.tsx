    ...
    <PortalLayout>
      <div className="flex min-h-screen flex-col items-center px-4 py-10">
        <div className="flex w-full max-w-lg flex-col items-center space-y-6 rounded-3xl p-6">
          ...
          {/* Profile Header */}
          <div className="flex w-full flex-col items-center space-y-4 relative">
            {/* Profile Image Container with Hover Effects */}
            <div className="relative h-40 w-40 rounded-full bg-gray-200 shadow-inner overflow-hidden group">
              <Image
                src={
                  previewImage ||
                  "/default-profile.png" // Ensure default image path is correct
                }
                alt="Profile Picture"
                layout="fill"
                objectFit="cover"
                className="object-cover transition duration-300 group-hover:filter group-hover:brightness-50 group-hover:blur-sm"
              />

              {/* Overlay for Hover Effects */}
              <div className="absolute inset-0 flex flex-col items-center justify-center opacity-0 transition-opacity duration-300 group-hover:opacity-100 bg-black bg-opacity-25">
          ...
          <div className="w-full space-y-4">
            <Link
              className="block w-full rounded-2xl bg-yellow-300 py-2 font-semibold text-gray-800 shadow-neumorphic text-center"
