...
export default function NotificationsPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-yellow-50 px-6 py-8">
      {/* Header */}
      <div className="flex items-center justify-between rounded-2xl bg-yellow-100 p-4 pb-6 shadow-neumorphic">
      ...
      <div className="mt-8 grid gap-8">
        {notifications.map((notification) => (
          <div
            key={notification.id}
            className={`grid grid-cols-1 gap-4 rounded-3xl border-l-8 bg-yellow-200 p-6 shadow-neumorphic md:grid-cols-2 ${notificationStyles[notification.type]}`}
          >
            ...
            <div
              className={`flex items-center justify-center rounded-2xl p-4 text-center shadow-neumorphic ${notificationStyles[notification.type]}`}
            >
