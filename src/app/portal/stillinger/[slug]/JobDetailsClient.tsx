...
const statusDetails: Record<string, { label: string; description: string }> = {
  ...
  finished: {
    label: 'Fullført',
    description:
      'Jobben er fullført og arbeidstaker har merket den som ferdig.',
  },
  confirmed: {
              ...
              <div className="text-sm text-gray-700">
                ...
                {userApplication.status === 'finished' && (
                  <p className="mt-1 text-yellow-600">
                    Du har merket jobben som ferdig – avventer arbeidsgivers
                    bekreftelse.
                  </p>
                )}
            ...
            {applications.length === 0 ? (
              ...
              <ul className="space-y-3">
                {applications.map((app) => {
                  ...
                  const badgeStyle =
                    statusStyles[app.status] || statusStyles.default;
