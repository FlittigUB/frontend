// src/app/portal/(home)/bedrift/home.tsx
...
const BusinessHomePage: React.FC = () => {
  ...
  return (
    <>
      <h1 className="mb-4 text-3xl font-bold">Bedrift Hjemmeside</h1>
      <div className="flex flex-row">
        <Button className="mx-2" variant={"outline"}>Policy</Button>
        <Button className="mx-2" variant={"outline"}>Rapporter skatt</Button>
      </div>
      <h2 className="mb-4 text-xl font-bold">Dine Publiserte Jobber</h2>
      <p className="mb-6">
