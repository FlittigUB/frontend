      ...
      <div className="container mx-auto px-4 py-12 md:px-6 lg:px-8">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          <div className="relative">
            <h2 className="mb-4 text-3xl font-bold tracking-tight">Hold deg oppdatert</h2>
          ...
          <div>
            ...
            <nav className="space-y-2 text-sm">
              ...
              <a href="/info/om-oss" className="block transition-colors hover:text-primary">
                Om oss
              </a>
              <a href="#" className="block transition-colors hover:text-primary">
                Kontakt
          ...
          <div>
            ...
            <address className="space-y-2 text-sm not-italic">
              ...
              <Link href={"mailto:kontakt@flittigub.no"}>Email: kontakt@flittigub.no</Link>
            </address>
          </div>
          <div className="relative">
